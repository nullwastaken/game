 ...
 **/
	...
	var Util = Util || {
		...
		inherits : function(subClass, superClass) {
			...
			if (Object['create']) {
				//c onsole.log(subClass,superClass);
	...
	Particle.prototype = {
		...
		addBehaviour : function(behaviour) {
			//RC
			if(behaviour instanceof Proton.Color){
				behaviour.initialize(this);	//aka not in update
				return;
			}
...
//the own renderer
	...
	CanvasRender.prototype.onParticleUpdate = function(particle) {
		if (particle.target) {
			...
			//RC
			this.context.fillRect(Tk.absToRel.x(particle.p.x), Tk.absToRel.y(particle.p.y), particle.radius, particle.radius);
			/*
 ...
 * You can use this emit particles.
 *
 * This method will c onsole.log the fixed number of your info  in updata or requestAnimationFrame
 * 
 ...
 */
	...
	var log = function() {
		/*if (window.c onsole && window.c onsole.log) {
			var arg = arguments;
